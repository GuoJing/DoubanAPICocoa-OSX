...
- (void)getDiscussionWithRemoteID:(NSString *)discussion_id
    ...
    NSString *apiUrl = [[NSString alloc] initWithFormat:kDOUDiscussionAPIUrl, discussion_id];
...
- (void)writeDiscussionWithTarget:(NSString *)target
    ...
    DOUService *service = [self getService];
    service.apiBaseUrlString = kHttpsApiBaseUrl;
    NSString *apiUrl = [[NSString alloc] initWithFormat:kDOUDiscussionsAPIUrl, target, target_id];
    DOUQuery *query = [[DOUQuery alloc] initWithSubPath:apiUrl parameters:nil];
